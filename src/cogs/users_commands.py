from discord import Option, OptionChoice, Embed, slash_command, Colour, SlashCommandGroup, Status  #Option(type[value]) se le pone a los argumentos dentro del comando para definir el tipo de valor
